    ...
    public partial class Win_Qul_InspectAutoRepair_U : UserControl
    {
        ...
        private void FillGrid()
        {
            ...
            try
            {
                ...
                sqlParameter.Add("BuyerArticleNo", chkArticle.IsChecked == true && !txtArticle.Text.Trim().Equals("") ?  txtArticle.Text : "");       //int. @Escape함수 삭제
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        foreach (DataRow item in drc)
                        {
                            ...
                            Win_Qul_InspectAutoRepair_U_Insert.InspectDate = lib.StrDateTimeBar(Win_Qul_InspectAutoRepair_U_Insert.InspectDate);
