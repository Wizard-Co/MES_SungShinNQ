...
namespace WizMes_SungShinNQ
{
    ...
    public partial class Win_ord_OutWare_Product_Q : UserControl
    {
        ...
        private void ComboBoxSetting()
        {
            ...
            ObservableCollection<CodeView> ovcOutClss = ComboBoxUtil.Instance.Gf_DB_CM_GetComCodeDataset(null, "OCD", "Y", "", "PROD");
            ...
            this.cboOutClss.ItemsSource = ovcOutClss;
        ...
        private void FillGrid()
        {
            ...
            try
            {
                ...
                sqlParameter.Add("chkOutClss", chkOutClss.IsChecked == true ? 1:0);
                sqlParameter.Add("OutClss", chkOutClss.IsChecked == true ? cboOutClss.SelectedValue?.ToString() : "01"); //cboOutClss.SelectedValue.ToString()
