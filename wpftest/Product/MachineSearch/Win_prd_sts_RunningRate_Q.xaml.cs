    ...
    public partial class Win_prd_sts_RunningRate_Q : UserControl
    {
        ...
        private void FillGrid()
        {
            try
            {
                ...
                DataSet ds = DataStore.Instance.ProcedureToDataSet("xp_prd_sMCRunningRate", sqlParameter, true);
        ...
        //                {
        //                    Title = "JoGwang [" + MainWindow.mMenulist[i].MenuID.Trim() + "] " + MainWindow.mMenulist[i].Menu.Trim() +
